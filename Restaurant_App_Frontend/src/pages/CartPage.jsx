                                        ...
                                        <tr key={item.productId}>
                                            ...
                                            <td className="text-center">
                                                <div className="btn-group btn-group-sm border rounded">
                                                    <button className="btn btn-light px-2" onClick={() => handleQuantityChange(item.productId, item.quantity, -1)} disabled={item.quantity <= 1}>-</button>
                                            ...
                                            <td className="text-end pe-4 fw-bold fs-5">{item.totalPrice} ₺</td>
